...
- **Depth anchor:** reconstructs H3 clean latents using the native `clean - noise` prediction, differentiably decodes an image, and compares frozen Depth Anything features. Start with 30+ swapped blocks and CPU-offloaded helpers.
