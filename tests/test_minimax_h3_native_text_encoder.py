...
from musubi_tuner.minimax_h3_native.media import H3AudioSource, H3Record, H3Reference
...
try:
    from musubi_tuner.minimax_h3_native_cache_text_encoder_outputs import _ref_teacher_presentation, _text_cache_metadata
