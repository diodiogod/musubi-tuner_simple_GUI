...
from musubi_tuner.minimax_h3_native import model as h3_model
from musubi_tuner.minimax_h3_native.model import (
    AdalnProj,
    FinalLayer,
    MiniMaxH3Config,
    MiniMaxH3Model,
...
def test_block_swap_runs_wait_device_assertion_forward_and_submit_in_order(monkeypatch):
    ...
    monkeypatch.setattr("musubi_tuner.minimax_h3_native.model.create_offloader", fake_create_offloader)
