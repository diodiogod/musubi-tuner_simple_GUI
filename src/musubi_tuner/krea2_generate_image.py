...
def build_pipeline(
    ...
    swap_config=None,
    projector_diff_path: str | None = None,
    ...
    mmdit = krea2_utils.load_krea2_dit(
        ...
        projector_diff_path=projector_diff_path,
        projector_diff_strength=projector_diff_strength,
    )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional tiny Krea 2 projector diff patch (.safetensors), applied at inference time without creating a merged checkpoint.",
    )
    parser.add_argument(
